    ...
    extend: {
      ...
      colors: {
        ...
        education: {
          ...
          "blue-light": "hsl(var(--education-blue-light))",
          teal: "hsl(var(--education-teal))",
          "teal-light": "hsl(var(--education-teal-light))",
          green: "hsl(var(--education-green))",
          "green-light": "hsl(var(--education-green-light))",
          orange: "hsl(var(--education-orange))",
          "orange-light": "hsl(var(--education-orange-light))",
          purple: "hsl(var(--education-purple))",
          "purple-light": "hsl(var(--education-purple-light))",
        },
        sidebar: {
